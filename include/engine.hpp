 ...
 * An instance of this class should be created in the main() function, and Engine::run() should be called to start the engine's main game loop.
 */
class Engine
{
private:
...
public:
     ...
     * You should pass the command-line arguments provided to your main() function in argc and argv
     ...
     *
     * If this function returns normally, the engine terminated with a success status.
     * An exception is thrown if any error occurs when running the engine.
     */
    void run();
